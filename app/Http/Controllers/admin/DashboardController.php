...
class DashboardController extends Controller
{
    public function index() {
        ...
        $stats = array(
            ...
            'recent_total_average' => Transaksi::whereYear('tanggal_invoice',$curr_year)->whereMonth('tanggal_invoice',$recent_month)->get()->count(),
            ...
            'curr_total_average' => Transaksi::whereYear('tanggal_invoice',$curr_year)->whereMonth('tanggal_invoice',$curr_month)->get()->count(),
